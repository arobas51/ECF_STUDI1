...
echo <<<HTML
    <section class="home-slider owl-carousel js-fullheight">
      <div class="slider-item js-fullheight" style="background-image: url(images/restaurant.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">

            <div class="col-md-12 col-sm-12 text-center ftco-animate">
            	<span class="subheading">Quai Antique</span>
              <h1 class="mb-4">Meilleure Restaurant</h1>
            </div>
      ...
      <div class="slider-item js-fullheight" style="background-image: url(images/bg_2.jpg);">
        ...
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-12 col-sm-12 text-center ftco-animate">
            	<span class="subheading">Quai Antique</span>
              <h1 class="mb-4">Nutritif &amp; Toast</h1>
            </div>
      ...
      <div class="slider-item js-fullheight" style="background-image: url(images/bg_3.jpg);">
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-12 col-sm-12 text-center ftco-animate">
            	<span class="subheading">Quai Antique</span>
              <h1 class="mb-4">De delicieuses specialités</h1>
            </div>
		...
		<section class="ftco-section ftco-wrap-about">
			<div class="container">
	          ...
	          <p>Une Belle Region nommée Savoie coule fournit les régéliales nécessaires. C'est une region magnifique, dans lequel des morceaux de phrases grillés vous sautent à la bouche.</p>
						<pc class="time">
							<span>Lun - Dim <strong>8h00 - 00h00</strong></span>
							<span><a href="#">+33 6 12 56 48 79</a></span>
						</p>
					</div>
				</div>
			</div>
          ...
          <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Anniversaires</h3>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Diner professionnelles</h3>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
...
s
		<section class="ftco-section">
			<div class="container">
				<div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-12 text-center heading-section ftco-animate">
          	<span class="subheading">L'equipe de Chef</span>
            <h2 class="mb-4"></h2>
          </div>
        </div>	
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-4">
								...
								<span class="position mb-2">Restaurant Propriétaire</span>
								<div class="faded">
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-4">
								<h3>Mathilde Fleur</h3>
								<span class="position mb-2">1e Chef</span>
								<div class="faded">
									<ul class="ftco-social d-flex">
		                <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
		                <li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
      ...
      <div class="container">
		...
		<section class="ftco-section bg-light">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-4">Messages recents</h2>
          </div>
        </div>
				<div class="row">
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              ...
              <div class="text pt-3 pb-4 px-4">
                ...
                <h3 class="heading"><a href="#">Goûtez aux délicieux plats d'Asie</a></h3>
                <p class="clearfix">
                  <a href="#" class="float-left read">Lire la suite</a>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-4">
            	...
            	<p>Loin loin, derrière le mot montagnes, loin des pays de Savoie vivent les saveurs.</p>
               <form action="#" class="subscribe-form">
                <div class="form-group">
                  <input type="text" class="form-control mb-2 text-center" placeholder="Entrer votre e-mail">
